...
Order _orderDeserialize(
  ...
  final object = Order();
  object.cashierId = reader.readStringOrNull(offsets[0]);
...
extension OrderByIndex on IsarCollection<Order> {
  Future<Order?> getByOrderId(String orderId) {
    return getByIndex(r'orderId', [orderId]);
  }

  Order? getByOrderIdSync(String orderId) {
  ...
  Future<List<Order?>> getAllByOrderId(List<String> orderIdValues) {
    final values = orderIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'orderId', values);
  }

  List<Order?> getAllByOrderIdSync(List<String> orderIdValues) {
    final values = orderIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByOrderId(Order object) {
    return putByIndex(r'orderId', object);
  }

  Id putByOrderIdSync(Order object, {bool saveLinks = true}) {
    return putByIndexSync(r'orderId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByOrderId(List<Order> objects) {
    return putAllByIndex(r'orderId', objects);
  }

  List<Id> putAllByOrderIdSync(List<Order> objects, {bool saveLinks = true}) {
...
extension OrderQueryWhere on QueryBuilder<Order, Order, QWhereClause> {
  ...
  QueryBuilder<Order, Order, QAfterWhereClause> orderIdEqualTo(String orderId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterWhereClause> orderIdNotEqualTo(
      String orderId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Order, Order, QAfterWhereClause> syncStatusEqualTo(
      String syncStatus) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Order, Order, QAfterWhereClause> syncStatusNotEqualTo(
      String syncStatus) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
